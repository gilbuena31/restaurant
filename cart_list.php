...
<?php $product_id = $row['id'] ?>
                                 ...
                                 <div class="input-group mb-3">
                                     ...
                                     <input id="p_minus" type="number" readonly value="<?php echo $row['qty'] ?>" min=1
                     ...
                     <div class="card">
                         <div class="card-body">
                             ...
                             <div class="text-center">
                                ...
                                if(isset($_SESSION['login_user_id'])){
                                ?>
                                 <a href="" class="btn btn-block btn-outline-primary" type="button" id="checkout">Proceed
                                     to Checkout</a>
                                <?php
                                } else {
                                ?>
                                 <button onclick="alert('Please Login First');" class="btn btn-block btn-outline-primary" type="button" id="checkout">Proceed
                                     to Checkout</button>
                                <?php
                                }
                                ?>
  ...
  <script type="text/javascript">
    var minus = $('#p_minus').val();
     $('#checkout').attr("href", "index.php?page=checkout");
 </script>
