<header class="masthead">
    ...
    <div class="container">
        <div class="card">
            <div class="card-body">
                <form action="" id="checkout-frm" method="post">
...
<!--                     <div class="w-100 m-auto my-3" style="max-width: 400px">
                        ...
                        <div class="alert alert-info text-center" role="alert">
                            <p class="mb-0">GCASH - Unavailable</p>
                        </div>
                    </div> -->

                    <div class="text-center">
                        <button type="submit" name="updatestock" class="btn btn-block btn-outline-primary">Place Order</button>
                    </div>
                </form>
            </div>
        </div>
